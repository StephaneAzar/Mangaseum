...
class MangasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manga" do
    assert_difference('Manga.count') do
      post mangas_url, params: { manga: { description: @manga.description, genre: @manga.genre, image_url: @manga.image_url, mangaka: @manga.mangaka, title: @manga.title, year: @manga.year } }
    end
  ...
  test "should update manga" do
    patch manga_url(@manga), params: { manga: { description: @manga.description, genre: @manga.genre, image_url: @manga.image_url, mangaka: @manga.mangaka, title: @manga.title, year: @manga.year } }
